		...
		{	
			...
			CGPROGRAM
				...
				void GS_Main(point v2g p[1], inout TriangleStream<g2f> triStream)
				{
                    ...
                    rotate2D(NEU.xz, rotation);
                    rotate2D(NED.xz, rotation);
                    rotate2D(NWU.xz, rotation);
                    rotate2D(NWD.xz, rotation);
                    rotate2D(SEU.xz, rotation);
                    rotate2D(SED.xz, rotation);
                    rotate2D(SWU.xz, rotation);
                    rotate2D(SWD.xz, rotation);
                    ...
                    rotate2D(nN.xz, rotation);
                    rotate2D(nS.xz, rotation);
                    rotate2D(nE.xz, rotation);
                    rotate2D(nW.xz, rotation);
                    rotate2D(nU.xz, rotation);
                    rotate2D(nD.xz, rotation);
